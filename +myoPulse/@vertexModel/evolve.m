function [ this ] = evolve( this, Tend, deltaT )
    ...
    while (~isempty(Te))
        ...
        EOM = @(t,X) myoPulse.equationOfMotion( t, X, this.d0{end}, this.d0{end}', this.d1{end}, this.Kappa, this.cTopo{1}, this.A0, ...
                                                this.tauL, this.alpha, this.Pb, this.bV{end}, this.bC{end}, this.omegaPulse, this.A, ...
                                                this.phiPulse, this.Fbc );
